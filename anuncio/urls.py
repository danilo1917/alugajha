...
#from .views import index, meus_anuncios, criar_conta, login_usr, logout_usr
from django.contrib.auth.views import  LoginView, LogoutView
from .views import  login_usr, ver_imovel, busca, AnuncioCreate
from .views import AnuncioUpdate, AnuncioDelete, AnuncioList, MeusAnunciosList, ContaCreate
urlpatterns = [
    ...
    path('meus_anuncios/excluir/<int:pk>', AnuncioDelete.as_view(), name = "excluir_anuncio"),
